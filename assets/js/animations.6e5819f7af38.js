...
(function () {
  ...
  function syncWebflowVideoControl(video, control) {
    ...
    var videoLabel = control.getAttribute("data-video-label") || "background video";
    control.setAttribute("aria-label", (isPaused ? "Play " : "Pause ") + videoLabel);
  ...
  function enhanceVideoControls() {
    document.querySelectorAll("video").forEach(function (video, index) {
      ...
      if (webflowControl) {
        ...
        webflowControl.addEventListener("click", function () {
          if (video.paused) {
            var playPromise = video.play();
      ...
      if (!video.hasAttribute("data-motion-video")) {
        pauseVideo(video);
        return;
      }
      ...
      var host = video.closest(".kineticare-hero") ||
        ...
        video.closest(".home-about-video") ||
        video.parentElement;
      ...
      var videoLabel = video.getAttribute("data-video-label") || "video";
      ...
      function syncButton() {
        ...
        button.setAttribute("aria-label", (video.paused ? "Play " : "Pause ") + videoLabel);
      }
